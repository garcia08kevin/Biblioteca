        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Paquete = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CiudadId = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    CuidadID = table.Column<int>(type: "integer", nullable: true),
                    VehiculoId = table.Column<int>(type: "integer", nullable: true, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NivelFragilidad = table.Column<int>(type: "integer", nullable: false),
                    EstadoPaqueteId = table.Column<int>(type: "integer", nullable: true, defaultValue: 1),
                    TamanioPaqueteId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "5787adee-2f80-440b-b1fc-259614946226", "64216b99-5f41-4808-885c-dfa0531e2d3f", "Viewer", "VIEWER" },
                    { "eb85d5a5-4b09-4dc3-8337-2f437d7fa34b", "10f9d1b0-e8e7-41c8-b70d-ef60ef9674eb", "Administrator", "ADMINISTRATOR" }
                });
